...
[![CRAN RStudio mirror downloads](http://cranlogs.r-pkg.org/badges/rbgm)](http://cran.r-project.org/web/packages/rbgm/index.html)
...
coordinate form or as Spatial objects. The aim is to make all of the following straightforward: 
